...
Two things land quickly — the obvious stuff:

- The [GLOSSARY:budget]budget[/GLOSSARY] must meet the legal definition of balance — this is a requirement, not a choice
- The [GLOSSARY:budget]budget[/GLOSSARY] is the mechanism for raising tax money — without it, the government cannot spend

But the more important realization comes next: the [GLOSSARY:budget]budget[/GLOSSARY] is the most important policy document the government produces. What gets funded gets done. What doesn't, doesn't. And a budget is only as good as the assumptions it's built on.

Which means the steward's job starts before the budget is adopted — and doesn't end when it is.

Two questions will guide you through the annual clock.

[VISUAL:The annual clock — a sense of the yearly budget cycle.]
...
[BILLBOARD]Every budget assumes things will go according to plan. What if they don't?[/BILLBOARD]
...
[BILLBOARD]This budget funds today. But is it mortgaging tomorrow?[/BILLBOARD]
[EXIT]Here's what to ask →[/EXIT]
